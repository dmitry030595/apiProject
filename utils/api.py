...
class GoogleMapsApi():
    ...
    def get_new_place(place_id):
        ...
        get_resource = "/maps/api/place/get/json"  # resource of method GET
    ...
    def put_new_place(place_id):
        ...
        put_resource = "/maps/api/place/update/json"  # resource of method PUT
    ...
    def delete_new_place(place_id):
        delete_resource = "/maps/api/place/delete/json"  # resource of method DELETE
